...
//     
//      // voice 2 
//      waveformMod3.frequency(freqTracker0);
//      waveformMod4.frequency(freqTracker0*0.501);// sub-oscillator down an octave, but slightly detuned
//      ladder2.frequency(freqTracker1*filter_cutoff);
//      // voice 3 
//      waveformMod5.frequency(freqTracker0);
//      waveformMod6.frequency(freqTracker0*0.501);// sub-oscillator down an octave, but slightly detuned
//      ladder3.frequency(freqTracker2*filter_cutoff);
//      // voice 4
//      waveformMod7.frequency(freqTracker0);
//      waveformMod8.frequency(freqTracker0*0.501);// sub-oscillator down an octave, but slightly detuned
